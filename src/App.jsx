        ...
        <div className="w-[90%] lg:w-[70%] md:w-[70%] m-auto relative z-10">
          ...
          <div className="flex flex-col w-full justify-evenly px-4 my-4 mt-[100px]">
            <div
              ...
              className="bg-secondary cursor-pointer hover:bg-slate-700 w-[250px] items-center justify-center inline-flex gap-5 px-5 py-1 rounded-2xl my-5 lg:relative lg:left-[80px]"
            >
            ...
            <div className="lg:flex md:flex lg:relative lg:left-[80px]">
              <div
                ...
                data-aos-easing="linear"
                data-aos-duration="1500"
                className="flex items-center justify-center lg:absolute md:absolute lg:w-[900px] md:w-[500px] lg:mb-10 md:mb-10 xl:w-[800px] "
              >
              ...
              <div
                data-aos="fade-up"
                data-aos-delay={300}
                className="lg:p-4 md:p-4 lg:w-[420px] md:w-[420px] lg:relative md:relative lg:left-[500px] 2xl:left-[700px] lg:h-[250px] md:h-[250px] lg:top-[120px] md:top-[150px] "
              >
                ...
                <div className="flex flex-col lg:flex md:flex lg:flex-row md:flex-row lg:items-center md:items-center lg:justify-start md:justify-start gap-6 items-start">
                  <SectionIcons />
                  <ButtonPrimay Link={"https://drive.google.com/file/d/1_lRTzuZkBB77hoTZyLcaboQX7Dt0GMqV/view"}>Download CV</ButtonPrimay>
                </div>
              </div>
            </div>
            <CardsProyect />
