...
export const information = [{
    ...
    jobs: {
        ...
        descriptionSpanish: "Hola, soy Pedro Arias, un desarrollador web y móvil con 1 año de experiencia. Trabajo principalmente con React y React Native, y he construido sitios web responsivos y aplicaciones móviles utilizando estas tecnologías. ¡Vamos a crear algo increíble juntos!",
        descriptionEnglish: "Hi, I'm Pedro Arias, a web and mobile developer with 1 year of experience. I primarily work with React and React Native, and I've built responsive websites and mobile apps using these technologies. Let's create something amazing together!"
    },
    projects:[
        {
          title: "Get that Home",
